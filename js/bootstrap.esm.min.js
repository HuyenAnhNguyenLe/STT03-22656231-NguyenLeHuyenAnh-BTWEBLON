...
class Carousel extends BaseComponent {
    ...
    _slide(e, t) {
        ...
        if (this._element.classList.contains("slide")) {
            ...
            const e = () => { o.classList.remove(c, E), o.classList.add("active"), i.classList.remove("active", E, c), this._isSliding = !1, setTimeout(h, 0) };
...
class Collapse extends BaseComponent {
    ...
    show() {
        ...
        if (e) { const i = e.find(e => n !== e); if (t = i ? Collapse.getInstance(i) : null, t && t._isTransitioning) return }
    ...
    static collapseInterface(e, t) {
        ...
        const i = {...Default$8, ...Manipulator.getDataAttributes(e), ... "object" == typeof t && t ? t : {} };
...
EventHandler.on(document, EVENT_CLICK_DATA_API$2, SELECTOR_DATA_TOGGLE$2, (function(e) {
    const t = getElementFromSelector(this);
    ["A", "AREA"].includes(this.tagName) && e.preventDefault(), EventHandler.one(t, EVENT_SHOW$3, e => { e.defaultPrevented || EventHandler.one(t, EVENT_HIDDEN$3, () => { isVisible(this) && this.focus() }) }), Modal.getOrCreateInstance(t).toggle(this)
...
})), EventHandler.on(window, EVENT_LOAD_DATA_API$1, () => SelectorEngine.find(OPEN_SELECTOR).forEach(e => Offcanvas.getOrCreateInstance(e).show())), defineJQueryPlugin(Offcanvas);
const uriAttrs = new Set(["background", "cite", "href", "itemtype", "longdesc", "poster", "src", "xlink:href"]),
    ARIA_ATTRIBUTE_PATTERN = /^aria-[\w-]*$/i,
    SAFE_URL_PATTERN = /^(?:(?:https?|mailto|ftp|tel|file):|[^#&/:?]*(?:[#/?]|$))/i,
    DATA_URL_PATTERN = /^data:(?:image\/(?:bmp|gif|jpeg|png|png|tiff|webp)|video\/(?:mpeg|mp4|ogg|webm)|audio\/(?:mp3|oga|ogg|opus));base64,[\d+/a-z]+=*$/i,
...
function sanitizeHtml(e, t, n) {
    ...
    for (let e = 0, n = o.length; e < n; e++) {
        ...
        if (!s.includes(i)) { n.remove(); continue }
...
class Tooltip extends BaseComponent {
    ...
    show() {
        ...
        l && i.classList.add(...l.split(" ")), "ontouchstart" in document.documentElement && [].concat(...document.body.children).forEach(e => { EventHandler.on(e, "mouseover", noop) });
    ...
    _setListeners() {
        this._config.trigger.split(" ").forEach(e => {
            if ("click" === e) EventHandler.on(this._element, this.constructor.Event.CLICK, this._config.selector, e => this.toggle(e));
                ...
                EventHandler.on(this._element, t, this._config.selector, e => this._enter(e)), EventHandler.on(this._element, n, this._config.selector, e => this._leave(e))
            }
...
class ScrollSpy extends BaseComponent {
    ...
    _getConfig(e) {
        if ("string" != typeof(e = {...Default$1, ...Manipulator.getDataAttributes(this._element), ... "object" == typeof e && e ? e : {} }).target && isElement(e.target)) {
            let { id: t } = e.target;
